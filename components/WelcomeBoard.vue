<template lang="pug">
.welcome-board
  .welcome-board__description
    .welcome-board__title DEVA HURMA
...
.welcome-board
    ...
    &__description
        @apply w-full p-24 z-20 flex flex-col sm:bg-transparent bg-white bg-opacity-40 border-0 sm:border-2 border-gray-100
    &__title
    ...
    &__button
        @apply bg-green-400 w-48 rounded-sm mt-8 px-4 py-2 text-white
</style>
